...
============================================================================*/
#ifndef gxsys_auto_ptr_hxx
#define gxsys_auto_ptr_hxx
...
# define gxsys_AUTO_PTR_REF 0
# define gxsys_AUTO_PTR_CONST const
# define gxsys_AUTO_PTR_CAST(a) cast(a)
#else
# define gxsys_AUTO_PTR_REF 1
# define gxsys_AUTO_PTR_CONST
# define gxsys_AUTO_PTR_CAST(a) a
#endif
...
public:
  ...
  template <class Y>
  auto_ptr(auto_ptr<Y> gxsys_AUTO_PTR_CONST& a) throw():
    x_(gxsys_AUTO_PTR_CAST(a).release())
    {
    }
  ...
  template <class Y>
  auto_ptr& operator=(auto_ptr<Y> gxsys_AUTO_PTR_CONST& a) throw()
    {
    this->reset(gxsys_AUTO_PTR_CAST(a).release());
    return *this;
    }
  ...
  /** Construct from another auto_ptr holding an object of the same
      ...
      auto_ptr.  */
  auto_ptr(auto_ptr gxsys_AUTO_PTR_CONST& a) throw():
    x_(gxsys_AUTO_PTR_CAST(a).release())
    {
    }
  ...
  auto_ptr& operator=(auto_ptr gxsys_AUTO_PTR_CONST& a) throw()
    {
    this->reset(gxsys_AUTO_PTR_CAST(a).release());
    return *this;
    }
