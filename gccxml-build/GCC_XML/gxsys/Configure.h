...
============================================================================*/
#ifndef gxsys_Configure_h
#define gxsys_Configure_h
...
#define gxsys_LFS_REQUESTED 1

/* Whether Large File Support is available.  */
#if gxsys_LFS_REQUESTED
# define gxsys_LFS_AVAILABLE 1
#endif
...
#  error "gxsys/Configure.h must be included before sys/types.h"
# endif
  /* Enable the large file API if it is available.  */
# if gxsys_LFS_AVAILABLE && \
     !defined(gxsys_LFS_NO_DEFINES)
#  if !defined(_LARGEFILE_SOURCE) && \
      !defined(gxsys_LFS_NO_DEFINE_LARGEFILE_SOURCE)
#   define _LARGEFILE_SOURCE
#  endif
#  if !defined(_LARGEFILE64_SOURCE) && \
      !defined(gxsys_LFS_NO_DEFINE_LARGEFILE64_SOURCE)
#   define _LARGEFILE64_SOURCE
#  endif
#  if !defined(_LARGE_FILES) && \
      !defined(gxsys_LFS_NO_DEFINE_LARGE_FILES)
#   define _LARGE_FILES
#  endif
#  if !defined(_FILE_OFFSET_BITS) && \
      !defined(gxsys_LFS_NO_DEFINE_FILE_OFFSET_BITS)
...
#  if defined(gxsys_EXPORTS)
#   define gxsys_EXPORT __declspec(dllexport)
#  else
#   define gxsys_EXPORT __declspec(dllimport)
#  endif
# elif __GNUC__ >= 4
#  define gxsys_EXPORT __attribute__ ((visibility("default")))
# else
#  define gxsys_EXPORT
# endif
#else
...
#if !defined(gxsys_NO_WARNING_ENABLE)
# if defined(_MSC_VER)
...
#if !defined(gxsys_NO_WARNING_DISABLE)
# if defined(_MSC_VER)
...
/* MSVC 6.0 in release mode will warn about code it produces with its
   ...
   by other compilers.  */
#if !defined(gxsys_NO_WARNING_DISABLE_BOGUS)
