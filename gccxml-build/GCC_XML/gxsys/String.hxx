...
============================================================================*/
#ifndef gxsys_String_hxx
#define gxsys_String_hxx
 ...
 */
class String: public gxsys_stl::string
{
  /** The original string type.  */
  typedef gxsys_stl::string stl_string;
...
inline bool operator<(String const& l, String const& r)
  {
  return (static_cast<gxsys_stl::string const&>(l) <
          static_cast<gxsys_stl::string const&>(r));
  }
#endif
