...
============================================================================*/
#ifndef gxsys_SystemTools_hxx
#define gxsys_SystemTools_hxx
...
#include <gxsys/String.hxx>

#include <sys/types.h>

// Required for va_list
#include <stdarg.h>
#if gxsys_STL_HAVE_STD && !defined(va_list)
...
namespace gxsys
{
  typedef gxsys_VA_LIST::hack_va_list va_list;
}
#endif // va_list
 ...
 */
class gxsys_EXPORT SystemToolsManager
{
public:
  SystemToolsManager();
  ~SystemToolsManager();
 ...
 */
class gxsys_EXPORT SystemTools
{
public:
