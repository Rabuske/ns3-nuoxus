...
#ifndef USED_FOR_TARGET
#define ENABLE_RTL_FLAG_CHECKING
#endif
...
#ifndef USED_FOR_TARGET
#define HAVE_LD_RO_RW_SECTION_MIXING
#endif
...
#ifndef USED_FOR_TARGET
#define PREFIX_INCLUDE_DIR "/usr/local/include"
#endif
...
/* Disable optimizations for MSVC.  They cause bugs.  */
#if defined(_MSC_VER)
# pragma optimize("", off)
#endif

#define GCC_TO_STRING(x) GCC_TO_STRING0(x)
#define GCC_TO_STRING0(x) #x

#define GCC_INCLUDE_DIR "bogus-include-dir"
