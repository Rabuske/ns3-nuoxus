...
#define MASK_SSEREGPARM (1 << 20)
#define MASK_STACK_PROBE (1 << 21)
#define MASK_SVR3_SHLIB (1 << 22)
#define MASK_TLS_DIRECT_SEG_REFS (1 << 23)
#define OPTION_MASK_UCLIBC (1 << 0)
#define MASK_3DNOW_A (1 << 24)
