...
const struct cl_option cl_options[] =
{
  ...
  { "-fxml-start=",
    "-fxml-start=<string>    Specify start locations for XML dump (use with -fxml)",
    N_OPTS, 11, 427,
    CL_CXX | CL_JOINED,
    0, CLVC_STRING, 0 },
  { "-fxml=",
    "-fxml=<file>    Enable XML output to a file (use with -fsyntax-only)",
    N_OPTS, 5, 428,
    CL_CXX | CL_JOINED,
    0, CLVC_STRING, 0 },
  { "-fxref",
  ...
  { "-iwithprefixbefore",
    ...
    0, CLVC_STRING, 0 },
  { "-iwrapper",
    "-iwrapper <dir>        Add <dir> to the end of the wrapper include path",
    N_OPTS, 8, -1,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_JOINED | CL_SEPARATE,
    0, CLVC_STRING, 0 },
  { "-lang-asm",
